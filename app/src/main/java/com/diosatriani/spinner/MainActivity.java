package com.diosatriani.spinner;
...
import com.diosatriani.spinner.adapter.Adapter;
import com.diosatriani.spinner.app.AppController;
import com.diosatriani.spinner.data.Data;
...
public class MainActivity extends AppCompatActivity {
    ...
    // sesuaikan dengan IP Address PC/laptop
    public static final String url = "http://192.168.1.3/spinner/menu.php";
    ...
    private void callData() {
        ...
        AppController.getController().addToRequestQueue(jArr);
    }
